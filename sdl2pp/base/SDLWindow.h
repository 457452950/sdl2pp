#pragma once
#ifndef SDL2_TEST_SDLWINDOW_H
#define SDL2_TEST_SDLWINDOW_H
...
namespace sdlpp {
    ...
    public:
        ...
        void SetAlwaysOnTop(bool alwaysOnTop) {
            SDL_SetWindowAlwaysOnTop(window_, alwaysOnTop ? SDL_TRUE : SDL_FALSE);
        }
        ...
        bool GetOpacity(float *opacity) {
            return SDL_GetWindowOpacity(window_, opacity) == 0;
        }
