...
std::shared_ptr<SDLSurface> sdlpp::ConvertSurface(std::shared_ptr<SDLSurface> src, uint32_t pixel_format_enum) {
    return SDLSurface::Create(SDL_ConvertSurfaceFormat(src->Get(), pixel_format_enum, 0));
}
